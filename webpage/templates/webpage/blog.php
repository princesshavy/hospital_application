...
<?php foreach ($results as $blog): ?>
         ...
         <article class="cs_post cs_style_1">
          ...
          <a class='cs_post_thumbnail position-relative' href='blog-details.html'>
            <img src="<?php echo $blog['image']; ?>" alt="Post Thumbnail">
          ...
          <div class="cs_post_content position-relative">
            <div class="cs_post_meta_wrapper">
              <div class="cs_posted_by cs_center position-absolute"><?php echo date("M d", strtotime($blog['time_posted'])); ?></div>
            ...
            <h3 class="cs_post_title"><a href='blog-details.html'><?php echo strip_tags($blog['title']); ?></a></h3>
            <p class="cs_post_subtitle"><?php echo substr(strip_tags($blog['body']), 0, 100) ; ?></p>
